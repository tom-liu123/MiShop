...
<script type="text/javascript">
	$(function(){
		$("#btn_add").click(function(){
		    var sum = $("#totalSum").html();//text();
			location.href = "orderController?method=createOrder&aid="+$("#address").val()+"&sum="+sum;
		})
	})
</script>
</head>
...
<div class="container" style="background-color: white;">
 				...
 				<tr>
 				 <td colspan="5">
 				 	...
 				 	<select id="address" style="width:60%" class="form-control">
 				 		<c:forEach items="${addresses}" var="a" varStatus="ai">
	...
	<div class="row">
		<div style="margin-left: 40px;">	  
	            <h4>商品金额总计：<span id="total" class="text-danger">￥&nbsp;&nbsp;<b id="totalSum">${sum}</b></span></h4>
		</div>
	</div>
